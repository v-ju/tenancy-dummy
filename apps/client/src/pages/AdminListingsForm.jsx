...
import { listingSchema } from '../../../../packages/shared/types/index.js';
...
const AdminListingsForm = () => {
    ...
    const {register, handleSubmit, formState:{errors} } = useForm({resolver: zodResolver(listingSchema),defaultValues:{}})
